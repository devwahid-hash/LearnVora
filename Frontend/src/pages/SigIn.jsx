      ...
      >
        ...
        <div className="relative bg-gray-900/90 backdrop-blur-xl shadow-2xl rounded-xl px-5 sm:px-6 py-5 sm:py-6 text-white overflow-hidden">
          ...
          >
            {/* Email */}
            <div>
              <label className="block text-sm mb-3 text-gray-300">Email</label>
              <input
              onChange={(e)=>{
              setemail(e.target.value)
                ...
                className="w-full px-5 py-3 rounded-md bg-gray-800/60 border border-gray-700 focus:border-purple-500 focus:ring-1 focus:ring-purple-400 outline-none text-base"
              />
            </div>

            {/* Password + Forgot Password */}
            <div>
              <label className="block text-sm mb-3   text-gray-300">Password</label>
              <input
              onChange={(e)=>{
                ...
                className="w-full px-5 py-3 rounded-md bg-gray-800/60 border border-gray-700 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-400 outline-none text-base"
              />
            ...
            <motion.button
              ...
              type="button"
              className="w-full flex items-center justify-center gap-4 py-4 rounded-md border border-gray-700 bg-gray-800/60 hover:bg-gray-700 transition-all duration-300 shadow-md text-base cursor-pointer"
            >
              <FcGoogle size={20} />
